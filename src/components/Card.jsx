        ...
        <div className="flip-card-front">
          ...
          <div className='h-full w-full pt-10 pb-5 px-8 sm:px-12 text-white flex justify-center items-center flex-col'>
            <div className='w-[95%] sm:w-[90%] mb-6 sm:mb-12 relative'>
              <p className="text-[24px] sm:text-[40px] text-white font-HalloweenMorning -mb-6 sm:-mb-10">{texts[language].front.header}</p>
              <p className="text-[50px] sm:text-[70px] text-white font-Munsteria -mb-[56px] sm:-mb-20">{texts[language].front.halloween}</p>
              <p className='font-HalloweenMorning -mb-4 sm:-mb-6 text-red-900 text-[60px] sm:text-[110px]'>{texts[language].front.aw}</p>
        
              <img alt='ghost' src={ghost} className='w-20 h-20 sm:w-36 sm:h-36 absolute top-16 sm:top-24 right-12 float-image' />
            </div>
            {texts[language].front.events.map((event, index) => (
              <div key={index} className="flex items-start justify-start gap-x-3 w-full mb-3 sm:mb-5 h-[54px]">
                ...
                <div className="w-[70%]">
                  <p className="text-[18px] sm:text-[20px] text-orange-500">{event.title}</p>
        ...
        <div className="flip-card-back">
          <div className='w-full h-full py-10 px-6 sm:px-12 text-white flex justify-center items-center flex-col'>
            <div className='w-[90%] mb-6 sm:mb-10 relative'>
              <p className="text-[20px] sm:text-[40px] text-white font-HalloweenMorning -mb-8 sm:-mb-12">{texts[language].back.header}</p>
              <p className="text-[60px] sm:text-[80px] text-white font-Munsteria -mb-[58px] sm:-mb-[78px]">{texts[language].back.halloween}</p>
            ...
            {texts[language].back.challenges.map((challenge, index) => (
              <div key={index} className="flex items-start justify-start gap-x-3 w-full mb-3 sm:mb-5 h-[60px] sm:h-[54px]">
                ...
                <div className="w-[80%]">
                  <p className="text-[18px] sm:text-[20px] text-orange-500">{challenge.title}</p>
